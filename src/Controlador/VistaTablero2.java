 ...
 * @author Dani
 */
public class VistaTablero2 extends javax.swing.JFrame {

    /**
     * Creates new form VistaTablero
     */
    public VistaTablero2() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaTablero2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaTablero2().setVisible(true);
            }
        });
    }
